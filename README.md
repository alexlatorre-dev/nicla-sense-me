...
**Live Demo**: [https://alexlatorre.github.io/nicla-sense-me/](https://alexlatorre.github.io/nicla-sense-me/)

### Available Pages

| Page | Description |
|------|-------------|
| **Monitor Dashboard** | Real-time sensor data visualization (orientation, environment, air quality) |
| **3D Visualizer** | 3D model that rotates with the Nicla orientation |
| **🎮 Tilt Game** | Procedurally generated infinite maze game controlled by tilting |
| **👋 Gestures** | Gesture detection demo (tilt, shake, movements in 6 directions) |
